...
<head>
  <meta charset="UTF-8" />
  <title>MineRecipe Studio – Minecraft 1.21+ Recipe Generator</title>
      ...
      <div>
        ...
        <div class="badge-row">
          ...
          <div class="badge">
            ...
            <span>3×3 grid, furnace & smithing layouts</span>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="panel-body">
        <div class="field-row">
          ...
          <div class="field" style="flex:1.2">
            ...
            <small>No <code>.json</code> – folders allowed, e.g. <code>weapons/netherite_upgrade</code></small>
          </div>
        </div>
    ...
    <section class="panel panel-editor">
      ...
      <div class="panel-body" id="editors">
          ...
          <div class="editor-grid-wrapper">
            ...
            <div class="slot-editor" id="shapedSlotEditor">
              ...
              <button class="btn" type="button" id="shapedClearSlotBtn">
                <span class="btn-icon">🧹</span> Clear slot
              </button>
        ...
        <div class="type-editor" data-editor="crafting_shapeless">
          <div class="type-header">
            <strong>Shapeless crafting – up to 9 ingredients</strong>
        ...
        <div class="type-editor" data-editor="cooking">
          <div class="type-header">
            <strong>Cooking recipes – furnace, smoker, blast furnace, campfire</strong>
        ...
        <div class="type-editor" data-editor="smithing_transform">
          <div class="type-header">
            <strong>Smithing – transform (upgrades)</strong>
            <span>Template + base + addition → new item</span>
          </div>
          <div class="editor-grid-wrapper">
        ...
        <div class="type-editor" data-editor="smithing_trim">
          <div class="type-header">
            <strong>Smithing – trim (armor trims)</strong>
            <span>Template + armor + material → trimmed armor</span>
          </div>
          <div class="editor-grid-wrapper">
            <div class="slot-editor" style="flex:1">
              <div class="slot-editor-title">
          ...
          <div class="warning-text tiny">
            Trim recipes don’t specify a <code>result</code> stack – the game copies and decorates the base armor item.
          </div>
        </div>
        ...
        <div class="type-editor" data-editor="crafting_decorated_pot">
          <div class="type-header">
            <strong>Decorated pot – special crafting serializer</strong>
        ...
        <div class="type-editor" data-editor="crafting_special">
          ...
          <div class="field">
            ...
            <select id="specialTypeSelect">
              <option value="minecraft:crafting_special_armordye">crafting_special_armordye – dye leather armor</option>
              <option value="minecraft:crafting_special_bannerduplicate">crafting_special_bannerduplicate – copy banner patterns</option>
              <option value="minecraft:crafting_special_bookcloning">crafting_special_bookcloning – copy written books</option>
              <option value="minecraft:crafting_special_firework_rocket">crafting_special_firework_rocket – fireworks</option>
              <option value="minecraft:crafting_special_firework_star">crafting_special_firework_star – firework stars</option>
              <option value="minecraft:crafting_special_firework_star_fade">crafting_special_firework_star_fade – add fades to stars</option>
              <option value="minecraft:crafting_special_mapcloning">crafting_special_mapcloning – copy maps</option>
              <option value="minecraft:crafting_special_mapextending">crafting_special_mapextending – zoom maps</option>
              <option value="minecraft:crafting_special_repairitem">crafting_special_repairitem – tool repair</option>
              <option value="minecraft:crafting_special_shielddecoration">crafting_special_shielddecoration – banner → shield</option>
              <option value="minecraft:crafting_special_shulkerboxcoloring">crafting_special_shulkerboxcoloring – recolor shulker boxes</option>
              <option value="minecraft:crafting_special_tippedarrow">crafting_special_tippedarrow – tipped arrows</option>
              <option value="minecraft:crafting_special_suspiciousstew">crafting_special_suspiciousstew – suspicious stew effects</option>
              <option value="minecraft:crafting_transmute">crafting_transmute – experimental special serializer</option>
            </select>
            <small class="hint">
              Special recipes ignore pattern/ingredients in JSON – the game implements the logic.
      ...
      <div class="panel-body">
        ...
        <div class="output-actions">
          ...
          <button class="btn" type="button" id="downloadJsonBtn">
            <span class="btn-icon">💾</span> Download <code>.json</code>
          </button>
        </div>
...
<script>
  ...
  const recipeTypes = [
    {
      ...
      label: 'Shaped',
      description: 'Pattern-based 3×3 crafting',
      group: 'Crafting',
      icon: '🧱',
      editorKey: 'crafting_shaped'
    },
    ...
    // Crafting specials and crafting_transmute – share the same editor
    {
  ...
  function selectRecipeType(typeId, editorKey, fromUser) {
    ...
    // For crafting_special, sync dropdown to typeId if it’s one of the specials
  ...
  // Build 3×3 grids for shaped & shapeless
  ...
  function buildCookingRecipe(typeId) {
    ...
    const resultStack = buildResultStack();
    if (resultStack) {
      // For smelting-like recipes, vanilla expects a string item ID; we’ll
